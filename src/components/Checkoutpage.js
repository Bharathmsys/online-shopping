...
const Checkoutpage = () => {
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",alignItems:"center",backgroundColor:"#FFFFE0",height:"100vh"}} className=''>
      ...
      {show?(<button type="submit" className='bg-primary text-white'  style={{width:"120px",height:"40px",border:"none",borderRadius:"8px",fontWeight:"600"}} value="Next">Add</button>):
